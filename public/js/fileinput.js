...
(function (factory) {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                   ...
                   // showUpload: true,
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="fa fa-fw fa-trash-alt"></i>',
                    ...
                    uploadRetryIcon: '<i class="fa fa-repeat" aria-hidden="true"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="fa fa-arrow-up" aria-hidden="true"></i>',
            fullscreen: '<i class="fa fa-arrows-alt" aria-hidden="true"></i>',
            borderless: '<i class="fa fa-window-maximize" aria-hidden="true"></i>',
