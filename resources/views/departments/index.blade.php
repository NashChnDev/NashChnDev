			...
			<div class="col-12">
				<div class="card card-primary card-outline">
				   <div class="card-header">
						<h3 class="card-title clearfix">Departments</h3>
						<div class="card-tools">
						   <a href="{{ route('department.department.create') }}" class="btn btn-sm pl-3 pr-3 bg-success float-right clearfix" title="Create New Company"  role="button">
...
<script>
    $(function() {
		$('#companies-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('get.department.data') !!}',
            columns: [
										{ data: 'deptcode', name: 'deptcode' },     
						{ data: 'deptname', name: 'deptname' },     
						     
						{ data: 'deptphone', name: 'deptphone' },     
						{ data: 'deptincharge', name: 'deptincharge' },     
						{ data: 'deptstatus', name: 'deptstatus' },     
