				...
				<div class="card card-primary card-outline">
				   <div class="card-header">
						...
						<div class="card-tools">
						   <a href="{{ route('employees.employee.create') }}" class="btn btn-sm pl-3 pr-3 bg-success float-right clearfix" title="Create New Employee"  role="button">
    ...
    $('body').on('click','.mailcopylink',function(){      
     ...
     var emailid = $(this).data('email'); 
      ...
      if(emailid != '' && emailid != undefined)
      {
        $.ajax({
          type:'GET',
          url:"employees/getmaillink/"+tempid,
          dataType:'json',
