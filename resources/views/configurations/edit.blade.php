...
@section('page-title','Configurations Edit')
			...
			<div class="row">
				<div class="col-12">
					<div class="card card-primary card-outline">
						<form method="POST" action="{{ route('configurations.configurations.update', $configurations->id) }}" id="edit_configurations_form" name="edit_configurations_form" accept-charset="UTF-8" class="form-horizontal">
							<div class="card-header">
								<h3 class="card-title clearfix">
								   {{ !empty($title) ? $title : 'Configurations' }}
