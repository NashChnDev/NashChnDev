...
@section('page-title','Production Lines New')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Production Lines New</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
			<div class="col-12">
				<div class="card card-primary card-outline">
					<form method="POST" action="{{ route('production_lines.production_lines.store') }}" accept-charset="UTF-8" id="create_production_lines_form" name="create_production_lines_form" class="form-horizontal">
						<div class="card-header">
							<h3 class="card-title clearfix">
							   Create New Production Lines
