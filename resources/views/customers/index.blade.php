			...
			<div class="col-12">
				<div class="card card-primary card-outline">
				   <div class="card-header">
						<h3 class="card-title clearfix">Customers</h3>
						<div class="card-tools">
						   <a href="{{ route('customers.customer.create') }}" class="btn btn-sm pl-3 pr-3 bg-success float-right clearfix" title="Create New Customer"  role="button">
						...
						<div class="card-body table-responsive">
							<table class="table table-sm table-hover" style="width:100%" id="customers-table">
								<thead>
									<tr>
         <th>Customer Code</th>
		 <th>Customer Name</th>
    ...
    $(function() {
		$('#customers-table').DataTable({
            ...
            columns: [
                        ...
                        { data: 'Customer_Types', name: 'Customer_Types' },    
						{ data: 'customeremail', name: 'customeremail' },     
						{ data: 'customermobile', name: 'customermobile' },     	
                        ...
                        { data: 'customerstatus', name: 'customerstatus' },     
