...
@section('page-title','Overall History Card')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Overall History Card</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
			  <li class="breadcrumb-item active">Overall History Card</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
			...
			<div class="col-12">
				<div class="card card-primary card-outline">
				   <div class="card-header">
						<h3 class="card-title clearfix">Overall History Card Filter</h3>
...
@endforeach
        ...
        <div class="row">
			<div class="col-12">
				<div class="card card-primary card-outline">
				   <div class="card-header">
						<h3 class="card-title clearfix">Overall History Card Data</h3>
						<div class="card-tools">
                            <a href="{{ route('reports.ExportOverallHistoryCard') }}" onclick="event.preventDefault();
                            ...
                            <a href="{{ route('reports.ExportAllOverallHistoryCard') }}"><button style="background-color:#d2e4f1" class="btn "><i class="fa fa-download"></i> Export (All)</button></a>   
						</div>
					</div>
					
						<div class="card-body table-responsive">
                             <form id="exportForm" action="{{  route('reports.ExportOverallHistoryCard') }}" method="GET">
        ...
        <th>Cost in INR</th>
        <th>Customer Code</th>
        <th>First Calibration Date</th>
        <th>Next Calibrated On</th>
        <th>Next Calibrated By</th>
        <th>Next Checked By</th>
        <th>Next Approved BY</th>
        <th>Next Approved On</th>
        <th>Next Calibration Result</th>
        <th>Last Calibrated On</th>
        <th>Last Calibrated By</th>
        <th>Last Calibrated Result</th>           
        <th>Created At</th>
        <th>Plant Id</th>
...
<script>
    ...
    $(function() {
		reg_table = $('#devicesObjects-table').DataTable({
            ...
            ajax:{"url":  '{!! route('get.overall_HistoryCard.data') !!}',
            'data':function ( d ) {
            ...
            columns: [
                        ...
                        { data: 'devices_storgelocation', name: 'devices_storgelocation' },    
                        { data: 'vendors_id', name: 'vendors_id' },    
                        { data: 'devices_dateofpurchase', name: 'devices_dateofpurchase' },    
                        { data: 'devices_costininr', name: 'devices_costininr' },    
                        { data: 'customer_id', name: 'customer_id' },    
                        { data: 'lastcalibrationdate', name: 'lastcalibrationdate' },    
                        { data: 'devices_CalibratedOn', name: 'devices_CalibratedOn' },    
                        { data: 'devices_CalibratedBy', name: 'devices_CalibratedBy' },    
                        { data: 'devices_CheckedBy', name: 'devices_CheckedBy' },    
                        { data: 'devices_ApprovedBY', name: 'devices_ApprovedBY' },    
                        { data: 'devices_ApprovedOn', name: 'devices_ApprovedOn' },    
                        { data: 'devices_CalibrationResult', name: 'devices_CalibrationResult' },    
                        { data: 'calibratedon', name: 'calibratedon' },    
                        { data: 'calibratedby', name: 'calibratedby' },    
                        { data: 'calibratedresult', name: 'calibratedresult' },    
                    ...
                    {
                        "aTargets" : [8,9,10,11,13,14,15,16,17],
                        "mData"    : null,
      ...
      
      {
                        ...
                        "mRender"  : function(data, type, full) {
                            ...
                            return '<input type="checkbox" name="selectExport[]" value="' +full['devices_id']+ '">';
                        }
                    }
                ] 
        })
...
$("#fromdate,#todate,#calibrateto,#deviceid,#devicecatagory,#devicedescription").on('change',function(){
    reg_table.draw();
});
