...
<link rel="stylesheet" href="{{ URL::asset('css/nashemployee.css') }}" />
                          ...
                          <li id="employment"><i class="fa fa-user-md" aria-hidden="true"></i><strong>Employment Details</strong><li>
                            <li id="skillset"><i class="fa fa-user-md" aria-hidden="true"></i><strong>Skill Details</strong><li>                          
                              <li id="otherdetails"><i class="fa fa-joomla" aria-hidden="true"></i><strong>Other Details</strong><li>
                                @if($type=="employee")
                                <li id="employeemanage"><i class="fa fa-joomla" aria-hidden="true"></i><strong>Employee Management Details</strong><li>
                                  @endif
                    </ul>
            ...
            <div class="col-md-8 offset-md-3" id="nash_joiningform" style="">
              ...
              <div class="card  mb-3 col-md-11 offset-md-1" id="otherdetails_section">  
                ...
                <div class="">
                  ...
                  <div class="otherbodys">

                  </div>                 
                </div>
              </div> 
                @if($type=="employee")
                  <div class="card  mb-3 col-md-11 offset-md-1" id="employeemanage_section">  
                    
                    <div class="">
                      <h5 class="card-title"style="cursor:pointer" id="employeemanage_modal_edit"><strong>Employee Management Details</strong><i class="fa fa-pencil" aria-hidden="true"></i></h5>
                      <div class="employeemanagebodys">
        ...
        <div class="modal" id="persModal"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          @push('scripts')
          <script>
            var personaldetail = new joiningPersonal('joiningform','@json($basic)','@json($country)','@json($plants)','@json($departments)');  
          </script>
          @endpush
@endsection
