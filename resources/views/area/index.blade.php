			...
			<div class="col-12">
				<div class="card card-primary card-outline">
				   <div class="card-header">
						<h3 class="card-title clearfix">Area</h3>
						<div class="card-tools">
						   <a href="{{ route('area.area.create') }}" class="btn btn-sm pl-3 pr-3 bg-success float-right clearfix" title="Create New Company"  role="button">
    ...
    $(function() {
		$('#companies-table').DataTable({
            ...
            columns: [
						...
						{ data: 'area_incharge', name: 'area_incharge' },
